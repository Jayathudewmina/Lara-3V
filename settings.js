...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "zdBEHbLL#JaYR0GlP8CxyYmGKiWC7cFts0SCId0P_ZS1HbOGNqzE", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94761104854",
DEV: process.env.DEV || "94761104854",
